...
export default function TripDiscoveryHeader() {
      ...
      <div className="max-w-[95vw] mx-auto flex items-center justify-between h-16">
        ...
        <div className="hidden lg:flex items-center gap-4">
          ...
          {isLoggedIn ? (
            ...
            <button className="bg-primary text-white px-4 py-2 rounded-md font-bebas tracking-wide">
              LOGIN
            </button>
          )}
        </div>
        ...
        <nav className="lg:hidden border-t border-slate-200">
          <div className="max-w-[95vw] mx-auto py-3 flex flex-col gap-3">
            ...
            {isLoggedIn ? (
              ...
              <button className="bg-primary text-white px-4 py-2 rounded-md font-bebas tracking-wide w-max">
                LOGIN
              </button>
            )}
          </div>
